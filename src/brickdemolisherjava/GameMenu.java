...
public class GameMenu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Brick Demolisher Main Menu");
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 30, 660, 320));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/bg9.png"))); // NOI18N
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(-44, 0, 710, 400));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        dispose();
        frame.setBounds(350, 120, 722, 600);
        frame.setTitle("Brick Demolisher");
