...
public class Controls extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Controls of Brick Demolisher");

        jLabel2.setText("1 - Normal Difficulty");

        jLabel3.setText("2 - Hard");

        jLabel4.setText("3 - Difficult");

        jLabel5.setText("Escape - Main Menu");

        jLabel6.setText("L - Leaderboard");

        jLabel7.setText("Enter - Restart");

        jLabel8.setText("Left Arrow Key - Left ");

        jLabel9.setText("Right Arrow Key - Right");
