...
public class GameLogInForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Brick Demolisher Login");
        ...
        jButton3.setBackground(new java.awt.Color(109, 140, 176));
        jButton3.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        jButton3.setForeground(new java.awt.Color(255, 255, 255));
        jButton3.setText("Don't have an account yet? Click Here!");
        jButton3.setToolTipText("Click to create an account");
        ...
        jButton4.setBackground(new java.awt.Color(109, 140, 176));
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 50, 490, 390));

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/bg6.gif"))); // NOI18N
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 600, 460));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String login = "SELECT * FROM BRICKPLAYERINFO WHERE username = ? AND PASSWORD = ?";
        try {
            ...
            if(rs.next()) {
                currentact = rs.getString("username"); // stores the logged in account to a variable to add the score later
                dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GameLogInForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
